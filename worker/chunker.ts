...
export interface TextChunk {
    index: number;      // Order (0-based)
    text: string;       // Chunk text (preserves original whitespace/newlines)
 ...
 */
export function splitIntoChunks(text: string, maxChars: number = 2500): TextChunk[] {

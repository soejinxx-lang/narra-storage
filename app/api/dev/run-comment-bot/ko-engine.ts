...
예: "아 거기서 칼 꺼내네 진짜" "로젠 저 장면 왜 저랬냐" "이번화 [인물] 폼 미쳤음ㅋ" "이거 [사건] 설정 구멍 아님?"` },
    // ── DC 날 것 — 흐릿한 (10) ────────────────────────────────────
    { weight: 10, hint: `짧고 날 것의 DC식 반응. 구체 언급 없이 즉흥적 분위기만.
예: "이거 좀 쎄한데" "뭔가 있음" "이상하다" "설마" "이거 진짜임?ㅋ" "불안하다"` },
    // ── DC 추리형 — 구체적 (17) ───────────────────────────────────
...
"지금 [인물] 평범해 보이는데 설정 공개되면 평가 뒤집힐 듯"` },
    // ── DC 추리형 — 흐릿한 (8) ────────────────────────────────────
    { weight: 8, hint: `독자가 작가 의도/떡밥을 탐지하는 추리형. 구체 언급 없이 분위기만.
예: "이거 한 번 꼬아놓을 거 같은데 불안하다" "나만 이상하게 보이냐"
"은근 떡밥 많이 깔려있는 거 같은데" "작가 수상하다"` },
];
